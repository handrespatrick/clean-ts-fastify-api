...
export class CreateCategoryService implements ICreateCategoryUseCase {
  constructor(private readonly _categoryRepository: ICreateCategoryRepository) {}

  async create(data: ICreateCategoryUseCase.Params): Promise<ICreateCategoryUseCase.Result> {
