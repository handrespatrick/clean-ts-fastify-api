...
describe('DeleteCategoryController', () => {
  ...
  beforeEach(() => {
    ...
    deleteCategoryController = new DeleteCategoryController(mockDeleteCategoryUseCase)
  })
  ...
  it('should return 200 with the deleted category data if deletion is successful', async () => {
    ...
    jest.spyOn(mockDeleteCategoryUseCase, 'delete').mockResolvedValueOnce(deletedCategory)
  ...
  it('should return 404 if category to delete is not found', async () => {
    ...
    jest.spyOn(mockDeleteCategoryUseCase, 'delete').mockResolvedValueOnce(errorResult)
  ...
  it('should return 500 if an unexpected error occurs', async () => {
    ...
    jest.spyOn(mockDeleteCategoryUseCase, 'delete').mockRejectedValueOnce(error)
