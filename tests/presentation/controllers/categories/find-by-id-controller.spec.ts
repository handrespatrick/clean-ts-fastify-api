...
describe('FindByIdCategoryController', () => {
  ...
  beforeEach(() => {
    ...
    findByIdCategoryController = new FindByIdCategoryController(mockFindByIdCategoryUseCase)
  })
  ...
  it('should return 200 with the found category data if retrieval is successful', async () => {
    ...
    jest.spyOn(mockFindByIdCategoryUseCase, 'findById').mockResolvedValueOnce(category)
  ...
  it('should return 404 if category is not found', async () => {
    ...
    jest.spyOn(mockFindByIdCategoryUseCase, 'findById').mockResolvedValueOnce(errorResult)
  ...
  it('should return 500 if an unexpected error occurs', async () => {
    ...
    jest.spyOn(mockFindByIdCategoryUseCase, 'findById').mockRejectedValueOnce(error)
